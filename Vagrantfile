...
Vagrant.configure("2") do |config|
  ...
  git clone https://github.com/dressalima/introducao-html-css.git /var/www/introducao-html-css
  git clone https://github.com/dressalima/Apache2-vagrant.git /etc/apache2/sites-enable
